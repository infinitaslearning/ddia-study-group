...
**Setup:** Disco Writer (Handles publications from Edify) & Disco GQL (Serving Data)
...
**Idea:** Use MongoDB transactions to make package updates safe
...
- No sharding
- No concurrency or Reads from Other service
...
- MongoDB Atlas
- **3-shard cluster**
- **Real concurrency** with heavy read load from Disco GQL
...
**The cluster became unresponsive and did not recover**
...
- No sharding (We did set up Sharding in local, but never had this)
- No concurrency
